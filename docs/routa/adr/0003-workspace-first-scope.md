...
- Date: 2026-02-25
- Derived
  from: [design-doc](../design-docs/workspace-centric-redesign.md), [issue #20](../issues/2026-02-25-gh-20-feat-workspace.md)
...
The `"default"` workspace exists as transition scaffolding for paths not yet fully migrated. It is not the target domain
model.
