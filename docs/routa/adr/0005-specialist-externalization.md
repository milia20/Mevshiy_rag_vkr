...
Specialists define agent roles (ROUTA, CRAFTER, GATE, DEVELOPER, etc.) with behavior instructions, model tier
preferences, and role reminders. Initially these were hardcoded in TypeScript.
...
- Users can override any bundled specialist by creating a same-named file in their workspace settings or
  `~/.routa/specialists/`.
