...
This release focuses on improving the Tauri desktop application user experience with enhanced menu navigation, keyboard
shortcuts, and fixing critical lifecycle issues in the Kanban workflow.
...
- [Tauri Menu Improvements](https://github.com/phodal/routa-js/blob/main/docs/issues/2026-03-15-tauri-menu-improvements.md) -
  Detailed menu changes
- [Kanban Lifecycle Fix](https://github.com/phodal/routa-js/blob/main/docs/issues/2026-03-15-kanban-repo-lifecycle-fix.md) -
  Repository workflow fix
