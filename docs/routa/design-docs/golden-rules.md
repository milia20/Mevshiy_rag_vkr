...
1. Treat `docs/ARCHITECTURE.md` as the top-level architecture contract unless a narrower canonical doc supersedes a
   subsection.
...
4. Avoid mixing normative guidance, brainstorming, and historical notes in the same file unless sections are clearly
   separated.
