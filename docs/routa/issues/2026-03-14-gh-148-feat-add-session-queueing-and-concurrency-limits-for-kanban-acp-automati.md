...
Kanban automation can currently start ACP coding sessions immediately without any board-level concurrency control. When
multiple cards are created or auto-advanced close together, Routa may attempt to launch more ACP sessions than the
configured provider capacity can handle.
