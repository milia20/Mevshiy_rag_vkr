...
> Based on deep analysis of 20 security findings from the Routa-JS project, summarizing the design principles and
> development approach for AI security scanning tools.

## 📋 Background

By analyzing the results of a commercial AI security scanning tool on the `routa-js` project, we can understand its core
detection principles and design a low-cost open-source alternative.
