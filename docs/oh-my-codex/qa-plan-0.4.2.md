...
- `dev` is ahead with feature/fix/test commits (auto-nudge improvements, all-workers-idle leader notification, tmux
  input/scrolling fixes, and coverage expansion).
