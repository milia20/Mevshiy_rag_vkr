...
This is a **stability + usability** release focused on team orchestration reliability, notification setup simplicity,
and safer OpenClaw operations.

---

## TL;DR

If you use `$team`/`omx team` heavily, this release makes the runtime more consistent by standardizing around *
*CLI-first interop**.
