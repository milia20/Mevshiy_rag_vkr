...
Diese Seite lokalisiert den Abschnitt **„Prompt tuning guide (concise + context-aware)”** aus der englischen
Hauptdokumentation.

Für die vollständige Integrationsdokumentation (Gateways, Hooks, Verifikation)
siehe [English guide](./openclaw-integration.md).
